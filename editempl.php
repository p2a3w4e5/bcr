...
function renderForm($id, $firstname, $lastname, $email, $address1, $address2, $city, $zip, $state, $role, $ssn, $phone, $accstatus )
{
...
?>       
                       ...
                       <!--                       <span class="asteriskField">
                                             ...
                                             <input type="text" class="form-control" id="txtPhone" name="txtPhone" value="<?php echo $phone; ?>" placeholder="Phone" required>       
                       ...
                       <!--                       <span class="asteriskField">
                                             ...
                                             <input type="text" class="form-control" id="txtSSN" name="txtSSN" value="<?php echo $ssn; ?>" placeholder="SSN" required>       
                ...
                <!--                      <span class="asteriskField">
                                    ...
                                    <select name="cmbRole" ID="cmbRole" class="select form-control" value="<?php echo $role; ?>" required> 
<?php                                   
                                       $theArray = array("Regular","Admin"); 
...
<?php                                   
                                       $theArray = array("Active","Suspended","Quit","Fired"); 
...
?>       
                                    ...
                                    <div class="form-group">
                                     <div>
                                         <input ID="btnUpdate" type="submit" value="Update Employee" name="submit" class="btn btn-primary"/>
...
// save the data to the database
    $sql = "UPDATE `empl_tbl` SET `first_name_txt`='$firstname',`last_name_txt`='$lastname',`email_txt`='$email',`address1_txt`='$address1',`address2_txt`='$address2',
            `city_txt`='$city',`zip_txt`='$zip',`state_txt`='$state',`empl_status_txt`='$accstatus' ,`ssn_txt`='$ssn' ,`role_txt`='$role',`phone_txt`='$phone'
             WHERE `id`='$id'";
...
$id = $_GET['id'];
$sql = "SELECT * FROM empl_tbl WHERE id = '$id'";  
...
renderForm($id, $firstname, $lastname, $email, $address1, $address2, $city, $zip, $state, $role, $ssn, $phone, $accstatus );
}
...
?>
                ...
                <hr />
                <div> 
                        <input type="button" value="Employees Search Page" class="btn btn-primary" onclick="window.location.href='viewempl.php'" />    
                </div>
                 <br />
                <footer>
