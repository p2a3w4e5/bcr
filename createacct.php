...
//        }
       ...
       $sql= "INSERT INTO `customers_tbl`(`id`, `user_id_txt`,`first_name_txt`, `last_name_txt`, `email_txt`, `address1_txt`, `address2_txt`, `city_txt`, `zip_txt`,`state_txt`,`account_status_txt`) 
                 VALUES ('$guid','$userid', '$firstname','$lastname','$email','$address1','$address2','$city','$zip','$state','$accstatus')";
      ...
      if(mysqli_query($db, $sql)){
            //echo "Records inserted successfully.";
            $insertStatus = "Account created successfully.";
...
<!--                      <span class="asteriskField">
                    ...
                    <div class="form-group">
                     <div>
                         <input ID="btnAdd" type="submit" value="Create Account" name="submit" class="btn btn-primary"/>
<!--                         <input ID="btnCancel" type="reset" value="Cancel" name="cancel" class="btn btn-primary"/>-->
                         <input type="button" value="Cancel" class="btn btn-primary" onclick="window.location.href='index.php'" />      
