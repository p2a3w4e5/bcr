...
//        }
       ...
       $sql= "INSERT INTO `empl_tbl` (`id`, `user_id_txt`, `first_name_txt`, `last_name_txt`, `email_txt`, `address1_txt`, `address2_txt`, `city_txt`, `state_txt`, `zip_txt`,`ssn_txt`,`phone_txt`, `empl_status_txt`,`role_txt`) 
                 VALUES ('$guid','$userid', '$firstname','$lastname','$email','$address1','$address2','$city','$state','$zip','$ssn','$phone','$accstatus','$role')";
      ...
      if(mysqli_query($db, $sql)){
         ...
         $sql= "INSERT INTO `login_tbl` (`user_id`, `password_txt`, `first_name_txt`, `last_name_txt`, `role_txt`) 
                 VALUES ('$userid','$userpass', '$firstname', '$lastname', '$role')";
                 ...
                 <div class="row">
                  <div class="col-md-6 col-sm-6 col-xs-12">
                   ...
                   <div class="form-group ">
                     <label class="control-label requiredField" for="txtUserID">
                      Employee ID used for logon
<!--                      <span class="asteriskField">
                       * <?php echo $titleErr;?>
                      </span>-->
                     </label>
                        <input pattern=".{3,50}" type="text" class="form-control" id="txtUserID" name="txtUserID" placeholder="User ID" required>       
                    </div>

                    <div class="form-group ">
                     <label class="control-label requiredField" for="txtPassword">
                      Login Password
<!--                      <span class="asteriskField">
                      * <?php echo $directorErr;?>
                      </span>-->
                     </label>
                        <input pattern=".{3,50}" type="password" class="form-control" id="txtPassword" name="txtPassword" placeholder="Password" required>          
...
<!--                      <span class="asteriskField">
                       * <?php echo $gengreErr;?>
                       ...
                       <!--                       <span class="asteriskField">
                                             ...
                                             <input pattern=".{8,10}" type="text" class="form-control" id="txtPhone" name="txtPhone" value="<?php echo $phone; ?>" placeholder="Phone" required>       

                                    </div>
                                      
                                        <div class="form-group ">
                                          
                                            <label class="control-label " for="txtSSN">
                                             SSN
                       <!--                       <span class="asteriskField">
                                              * <?php echo $priceErr;?>
                                             </span>-->
                                             ...
                                             <input pattern=".{9,9}" type="text" class="form-control" id="txtSSN" name="txtSSN" value="<?php echo $ssn; ?>" placeholder="SSN" required>       

                                    </div>
                      
                                          <div class="form-group ">
                                            <label class="control-label requiredField" for="cmbStatus">
                                            Status
                       <!--                      <span class="asteriskField">
                                              * <?php echo $gengreErr;?>
                                             </span>-->
                                                ...
                                                <select name="cmbStatus" ID="cmbStatus" class="select form-control" required>
                                         ...
                                         <div class="form-group ">
                                            <label class="control-label requiredField" for="cmbRole">
                                            Role
                       <!--                      <span class="asteriskField">
                                              * <?php echo $gengreErr;?>
                                             </span>-->
                                                ...
                                                <select name="cmbRole" ID="cmbRole" class="select form-control" required>
                                                       <option selected value="">Role...</option>
                    ...
                    <div class="form-group">
                     <div>
                         <input ID="btnAdd" type="submit" value="Add New Employee" name="submit" class="btn btn-primary"/>
