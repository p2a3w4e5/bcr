...
?>
               ...
               <div class="container body-content">
                ...
                <div class="bootstrap-iso">
                    <div id="search">     
                          <h3>Search  Movies For Rent</h3> 
              	    <p>You  may search either by movie title, director, actors or release date</p> 
                    <form  method="post" action="rentview.php?go"  id="searchform"> 
...
//                            if ($m >= $start)
       ...
       //                        if ($m == $start) { break; }
                               ...
                               echo '<td><a href="addtorent.php?id=' . $row['id'] . '" onclick="return confirmRent()">Rent</a></td>' ;
...
<!--                </div>-->
                <hr />
                <div> 
                        <input type="button" value="Main Page" class="btn btn-primary" onclick="window.location.href='index.php'" />   
                        <input type="button" value="Check Out" class="btn btn-primary" onclick="window.location.href='checkout.php'" />  
